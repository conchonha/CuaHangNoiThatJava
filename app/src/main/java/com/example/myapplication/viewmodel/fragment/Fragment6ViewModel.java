...
*/
public class Fragment6ViewModel extends AndroidViewModel {
    public MutableLiveData<ArrayList<Sanpham>>listSanPham = new MutableLiveData<>();
    public Fragment6ViewModel(@NonNull Application application) {
        super(application);
    }

    public void getdatasanpham() {
        DataService dataService= APIServices.getService();
        Call<List<Sanpham>> callback=dataService.getdatarealme();
