...
*/
public class TheLoaiKhacViewModel extends AndroidViewModel {
    public MutableLiveData<ArrayList<Sanpham>> listSanPham = new MutableLiveData<>();
    public TheLoaiKhacViewModel(@NonNull Application application) {
        super(application);
    }

    public void getdatasanpham() {
        DataService dataService= APIServices.getService();
        Call<List<Sanpham>> callback=dataService.getdatasony();
