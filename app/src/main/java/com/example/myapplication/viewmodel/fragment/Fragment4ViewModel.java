...
*/
public class Fragment4ViewModel extends AndroidViewModel {
    public MutableLiveData<List<Sanpham>> listSanPham = new MutableLiveData<>();

    public Fragment4ViewModel(@NonNull Application application) {
        super(application);
    }

    public void getdatasanpham() {
        DataService dataService= APIServices.getService();
        Call<List<Sanpham>> callback=dataService.getdatahuawei();
